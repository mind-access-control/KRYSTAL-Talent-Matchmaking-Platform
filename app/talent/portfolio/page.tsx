...
export default function TalentPortfolio() {
  ...
  const handleUpload = () => {
    if (!selectedFile || !uploadDescription.trim()) {
      showToast("Please select a file and add a description", "error")
      return
    }
    ...
    const newItem: MediaItem = {
      ...
      url: `/placeholder.svg?height=300&width=300&query=${uploadDescription}`,
  ...
  const handleSaveEdit = () => {
    ...
    setMediaItems((prev) =>
      prev.map((item) => (item.id === editingItem.id ? { ...item, description: editDescription } : item)),
    )
    setEditingItem(null)
    setEditDescription("")
      ...
      <div className="space-y-6">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <p className="text-muted-foreground mt-1">Showcase your best work to attract potential clients.</p>
          </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              <Input id="file" type="file" accept="image/*,video/*" onChange={handleFileSelect} />
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                rows={3}
              />
              <p className="text-xs text-muted-foreground">{uploadDescription.length}/150 characters</p>
            </div>

            <Button onClick={handleUpload} disabled={!selectedFile || !uploadDescription.trim()}>
              Upload Media
            </Button>
          </CardContent>
        </Card>
          ...
          <CardContent>
            ...
            {mediaItems.length === 0 && (
              <div className="text-center py-12">
                ...
                <p className="text-muted-foreground">Start building your portfolio by uploading your best work.</p>
              </div>
            )}
          </CardContent>
        </Card>
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  rows={3}
                />
                <p className="text-xs text-muted-foreground">{editDescription.length}/150 characters</p>
              </div>
